...
REUSED UNCHANGED from the reforecast pipeline. These transforms only
operate on 'step' (lead time), never on 'time' -- so they're entirely
agnostic to whether 'time' holds hindcast years or real-time
